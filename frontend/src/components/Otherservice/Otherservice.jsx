    ...
    <div className="otherservice">
      <div className="os-container">
        <h1 className="heading">Other Services</h1>
            ...
            //   </div>
            // </div> */}
            <Slider {...settings} style={{margin:"auto",padding:"30px"}}>
                        {services.map((service) => (
            <div  onClick={() => handleCardClick(service)}>
            <div className="card" style={{border:'1px solid #419CFD',padding:'10px',backgroundColor:'rgba(20, 20, 20, 0.959)',borderRadius:"10px",color:'white',width:'350px',height:'400px',margin:"10px",cursor:"pointer"}} >
            <div className="card-body" style={{display:'flex',flexDirection:'column'}}>
            <div  className="card-title" style={{color:'white',fontWeight:'bolder',borderRadius:"15px",padding:'5px',margin:'auto',fontSize:"20px"}}>{service.title}</div>
              <img  src={service.image}  style={{padding:'20px',height:'50%'}}/>
