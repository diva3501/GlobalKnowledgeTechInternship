    ...
    "All": [
      ...
      },
      {
        ...
        description: `
          ...
          For any further queries, get top-notch coaching on Tableau, a finest business intelligence tool, from the best Tableau training institutes in Bangalore - Global Knowledge Technologies.
        `
      },
      {
      ...
      },
      {
        ...
        description: `
          ...
          For any further queries, learn Anypoint Platforms Operations, Architecture and Development from the top MuleSoft training institute in Bangalore - Global Knowledge Technologies.
        `
      }
    ],
    "Popular Courses":  [
    ...
    "Role Based Courses": [
      {
        ...
        courseCode: "", // You can add specific codes if needed
        duration: "4 Hours",
        price: "Contact For Pricing",
        description: `
      ...
      },
      {
        ...
        courseCode: "", // You can add specific codes if needed
        duration: "", // Add duration if specified
        price: "", // Add price if specified
        description: `
