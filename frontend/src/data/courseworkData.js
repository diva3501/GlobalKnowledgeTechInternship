const courseworkData = {
    "All":[
        {
            title: "IBM Content Navigator 2.0.3.6 - Box Integration",
            description: `
      Course Title: IBM Content Navigator 2.0.3.6 - Box Integration
      ...
      For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
        ...
        {
          title: "Watson Explorer Foundational Components (v11)",
          description: `
            **Course Code:** O3100G
            **Duration:** 32 Hours
            **Price:** INR 45250.00
            
            **Course Description:** In this course, you will learn the core features and functionality of Watson Explorer Foundational Components. This core functionality is found in all editions of Watson Explorer (Enterprise and Advanced edition).
            ...
            **Further Queries:** For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          `,
          image: "all2.png"
        },
        {
          ...
          description: `
            ...
            **Further Queries:** Get top-notch coaching on Tableau, a finest business intelligence tool, from the best Tableau training institutes in Bangalore - Global Knowledge Technologies.
          `,
          image: "all3.png"
        },
        {
          ...
          description: `
            ...
            **Course Description:** This Tableau Desktop II course is designed to provide you with the skills required to become a Tableau power user. The course is designed for the professional who has solid working experience with Tableau and wants to take it to the next level.
        ...
        },
        {
          ...
          description: `
            ...
            **Course Description:** This Tableau Desktop III course is designed to provide you with the skills required to become a Tableau power user. The course is designed for the professional who has solid working experience with Tableau and wants to take it to the next level.
        ...
        },
        {
          ...
          description: `
            ...
            **Further Queries:** Learn Anypoint Platforms Operations, Architecture and Development from the top MuleSoft training institute in Bangalore - Global Knowledge Technologies.
          `,
          image: "all6.png"
        }
      ],
    ...
    "Role Based Courses": [
        {
            title: "IBM - ML Non Engineering",
            description: `
      Course Title: IBM - ML Non Engineering
      ...
      For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "IBM ML - Engineer",
            description: `
      Course Title: IBM ML - Engineer
      ...
      For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "IBM ML - Deep Learning Engineer",
            description: `
      Course Title: IBM ML - Deep Learning Engineer
      ...
      For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "IBM IIB Solution Architect",
            description: `
      Course Title: IBM IIB Solution Architect
      ...
      For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "IBM IIB Solution Developer",
            description: `
      Course Title: IBM IIB Solution Developer
      ...
      For any further queries, feel free to contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "IBM MQ Practitioner",
            description: `
      Course Title: IBM MQ Practitioner
    ...
    "Digital Courses": [
        {
            ...
            description: `
      Course Title: IBM Certified Application Developer - Cloud Platform V2
      ...
      image: "digital1.png"
          ...
          {
            title: "IBM Certified Solution Advisor - SoftLayer V1",
            description: `
      Course Title: IBM Certified Solution Advisor - SoftLayer V1
      ...
      image: "digital2.png"
          },
          {
            ...
            description: `
      Course Title: IBM Certified Solution Advisor - DevOps V1
      ...
      image: "digital3.png"
          ...
          {
            title: "IBM Certified Deployment Professional - Rational UrbanCode Deploy",
            description: `
      Course Title: IBM Certified Deployment Professional - Rational UrbanCode Deploy
      ...
      image: "digital4.png"
          ...
          {
            title: "IBM Certified Deployment Professional - Rational UrbanCode Release",
            description: `
      Course Title: IBM Certified Deployment Professional - Rational UrbanCode Release
      ...
      image: "digital5.png"
          ...
          {
            title: "IBM Certified Solution Architect - Cloud Platform Solution V2",
            description: `
      Course Title: IBM Certified Solution Architect - Cloud Platform Solution V2
    ...
    "Free Courses": [
        {
            title: "IBM Cloud Application Developer V3",
            description: `
      Course Title: IBM Cloud Application Developer V3
      
      Course Code: C1000-007
      Duration: 3 Days
      Price: Contact For Pricing
      ...
      image: "free1.png"
          ...
          {
            title: "IBM Certified System Administrator - MQ V8.0",
            description: `
      Course Title: IBM Certified System Administrator - MQ V8.0
      
      Course Code: C9530-410
      Duration: 1 Day
      Price: Contact For Pricing
      ...
      For more information, please contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "Foundations of IBM Cloud V1",
            description: `
      Course Title: Foundations of IBM Cloud V1
      
      Course Code: C1000-039
      Duration: 3 Days
      Price: INR 64900.00
      ...
      For detailed information, please contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "Introduction to IBM Cúram Social Program Management 7.X: Functional Overview",
            description: `
      Course Title: Introduction to IBM Cúram Social Program Management 7.X: Functional Overview
      ...
      For more details, please contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          },
          {
            title: "Tableau Desktop III - Advanced",
            description: `
      Course Title: Tableau Desktop III - Advanced
      ...
      For top-notch coaching on Tableau, a leading business intelligence tool, contact one of the top software training institutes in Bangalore - Global Knowledge Technologies.
          ...
          {
            title: "Maximo 7.6 Workforce Management",
            description: `
      Course Title: Maximo 7.6 Workforce Management
