...
function Offers() {
  ...
  const courses = [
    ...
    { id: 3, name: 'Tableau Advanced', category: 6, description: 'Advance your skills in Tableau with advanced features.', image: 'https://img.freepik.com/free-vector/flat-hand-drawn-people-analyzing-growth-chart-illustration_23-2148859388.jpg?t=st=1720205712~exp=1720209312~hmac=25a8f22f31aea9afdb14f3e2cc95020e433120a8d5ea44021bd2e412a092b370&w=900' },
    { id: 4, name: 'Tableau Expert', category: 6, description: 'Become a Tableau expert with in-depth knowledge.', image: 'https://img.freepik.com/premium-vector/market-forecast-trend-use-chart-graphic-vector-business-market-forecast-graph-data-financial-analysis-trend-illustration_102902-6006.jpg?w=900' },
  ];
